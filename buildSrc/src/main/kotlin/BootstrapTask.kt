...
open class BootstrapTask : DefaultTask() {
    ...
    private fun getBootstrap(): JSONArray? {
        ...
        val url = "https://raw.githubusercontent.com/" +
                "${ProjectValues.owner}/" +
                "${ProjectValues.repo}/" +
                "${ProjectValues.releaseBranch}/plugins.json"
                ...
                if (it.project.properties.containsKey("PluginName") && it.project.properties.containsKey("PluginDescription")) {
                    ...
                    releases.add(JsonBuilder(
                            ...
                            "url" to "https://github.com/" +
                                    "${ProjectValues.owner}/" +
                                    "${ProjectValues.repo}/blob/" +
                                    "${ProjectValues.releaseBranch}/release/${it.project.name}-${it.project.version}.jar?raw=true",
                    ...
                    val pluginObject = JsonBuilder(
                            ...
                            "provider" to ProjectValues.owner,
                            "projectUrl" to ProjectValues.discord,
